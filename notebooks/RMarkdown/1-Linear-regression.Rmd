...
#ax.scatter(data.sqft, data.price, alpha=0.6, edgecolors="k")
...
SIZE = ((data.sqft - data.sqft.mean())/data.sqft.std()).values
TRUEVALUES = data.price.values
